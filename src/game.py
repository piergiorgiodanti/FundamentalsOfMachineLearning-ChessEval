...
import chess
import torch
from src.data_utils import PerspectiveVectorizer, StaticFlatVectorizer
from src.models import ChessVanillaCNN, ChessResNet #DeepChessResNet
...
if __name__ == "__main__":
    ...
    encode = ChessResNet()
    model = ChessVanillaCNN().to(device)
    path_modello = "../models_saved/chess_model2.pth"
